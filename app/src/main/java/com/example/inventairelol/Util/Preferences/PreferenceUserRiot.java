...
public class PreferenceUserRiot {

    Context context;
    SharedPreferences sharedPreferences;

    public PreferenceUserRiot(Context context) {
        this.context = context;
        this.sharedPreferences = context.getSharedPreferences("accountLolRiot", MODE_PRIVATE);
